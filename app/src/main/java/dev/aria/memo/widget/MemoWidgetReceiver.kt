 ...
 *    </receiver>
 *
 * State cleanup on widget removal: [GlanceAppWidgetReceiver.onDeleted] in
 * Glance 1.1.x already invokes the underlying [GlanceAppWidget]'s state
 * teardown for each removed instance, so an explicit override is unnecessary.
 *
